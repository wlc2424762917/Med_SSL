...
dir_path = r"C:\Users\wlc\PycharmProjects\MRes_Pipeline\data\pig_dataset\pig_dataset\training"
    ...
    if file_name.endswith(".nrrd") and img_format in file_name:
        ...
        for i in range(n):
            ...
            if np.sum(label_slice != 0) != 0:
                ...
                img_slice = img_slice[row-35:row+35, col-35:col+35]
                label_slice = label_slice[row-35:row+35, col-35:col+35]
                myo_slice = myo_slice[row-35:row+35, col-35:col+35]
                sr_slice = zoom(img_slice, 512 / 70, order=3)
