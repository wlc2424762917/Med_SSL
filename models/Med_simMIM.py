...
from models.swin_transformer_seg import SwinTransformer
...
if __name__ == "__main__":
    ...
    mask_generator = MaskGenerator(input_size=224, mask_patch_size=32, model_patch_size=4, mask_ratio=0.6)
    ...
    mask = torch.from_numpy(mask_generator()).unsqueeze(0).float()
    out = model(x, mask)
    print(out)
