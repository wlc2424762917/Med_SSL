...
from utils.loss_functions import sr_Loss
...
parser = argparse.ArgumentParser(description="super-resolution and segmentation pipeline")
parser.add_argument("--checkpoint", default=None, help="start training from saved checkpoint")
parser.add_argument("--logdir", default="test", type=str, help="directory to save the tensorboard logs")
parser.add_argument(
    "--pretrained_dir", default="./pretrained_models/", type=str, help="pretrained checkpoint directory"
)
parser.add_argument("--data_dir", default="./data/synapse/", type=str, help="dataset directory")
...
parser.add_argument("--infer_overlap", default=0, type=float, help="sliding window inference overlap")
...
def main_worker(gpu, args):
    ...
    dice_acc = DiceMetric(include_background=False, reduction=MetricReduction.MEAN, get_not_nans=False)
    psnr_acc = PSNRMetric(max_val=1, reduction=MetricReduction.MEAN, get_not_nans=False)
    sr_loss = sr_Loss(args.sr_loss)

    # --sliding window inference (not used)--- #
    ...
    if args.seg:
        ...
        accuracy = run_training(
            ...
            val_loader=loader[1],
            optimizer=optimizer,
            loss_func=[dice_loss, sr_loss],
            acc_func=[dice_acc, psnr_acc],
            args=args,
            model_inferer=None,
            scheduler=scheduler,
            start_epoch=start_epoch,
